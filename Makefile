.PHONY: build test test-unit test-integration test-ci lint clean install release evolve evolve-dry
...
evolve:
	powershell -ExecutionPolicy Bypass -File _examples/evolve/evolve.ps1

evolve-dry:
	powershell -ExecutionPolicy Bypass -File _examples/evolve/evolve.ps1 -DryRun
