...
func looksLikeEnumRef(sqlType string) bool {
	...
	knownTypes := map[string]bool{
		...
		"varchar": true, "char": true, "character": true, "nvarchar": true,
		"text": true, "uuid": true,
		"bool": true, "boolean": true,
		"date": true, "time": true, "timetz": true,
		"timestamp": true, "timestamptz": true, "datetime": true,
		"interval": true,
		"real":     true, "double": true, "float": true, "float4": true, "float8": true,
		"numeric": true, "decimal": true,
		"json": true, "jsonb": true, "xml": true, "xmlpath": true,
		"bytea": true, "inet": true, "cidr": true, "macaddr": true, "macaddr8": true,
		"money": true, "bit": true, "varbit": true,
		"tsvector": true, "tsquery": true,
		"oid": true, "path": true, "point": true, "polygon": true,
		"line": true, "box": true, "circle": true, "lseg": true,
		"hstore": true, "citext": true,
		"int4range": true, "int4multirange": true, "int8range": true, "int8multirange": true,
		"numrange": true, "nummultirange": true, "tsrange": true, "tsmultirange": true,
		"tstzrange": true, "tstzmultirange": true, "daterange": true, "datemultirange": true,
	}
